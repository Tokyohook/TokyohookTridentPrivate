...
local Window = Library:CreateWindow({Title = 'Tokyohook | Private',Center = true, AutoShow = false})
Library:SetWatermark('Tokyohook | Private')
...
ThemeManager:SetFolder('TokyohookPrivateTRIDENT')
SaveManager:SetFolder('TokyohookPrivateTRIDENT/Configs')
